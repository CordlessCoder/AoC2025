...
| Day | Part 1 | Part 2 |
| :---: | :---: | :---:  |
| [Day 1](./src/bin/01.rs) | `26.9µs` | `15.5µs` |
| [Day 2](./src/bin/02.rs) | `425.0ns` | `14.1µs` |
| [Day 3](./src/bin/03.rs) | `15.1µs` | `32.0µs` |
| [Day 8](./src/bin/08.rs) | `3.2ms` | `9.1ms` |
| [Day 11](./src/bin/11.rs) | `77.7µs` | `154.0µs` |
